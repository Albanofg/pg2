            ...
            <MAP>
                ...
                <THE_MACHINE>
                    ...
                    <LOGIC>
                        ...
                        STEP 4 — SELF-CHECK. After your rewrite, the mechanism is a real how+constraint (would not read as "display information on a generic computer"); the user-facing `restatement` and `mechanism` contain NO legal words — none of claim/patent/patentable/prior-art/novelty/examiner/§101 — and no statutes (UPL); you did not imply the idea is patentable. Fix and re-run.
                    </LOGIC>
                </THE_MACHINE>
